...
?>
    <?php for ($count = 0; $count < 0; $count++): $cat_metakey = 'extra_text_0'.$count; ?>
    <tr class="form-field">
    ...
    <?php for ($count = 0; $count < 0; $count++): $cat_metakey = 'extra_textarea_0'.$count; ?>
    <tr class="form-field">
    ...
    <?php for ($count = 0; $count < 0; $count++): $cat_metakey = 'upload_image_0'.$count; ?>
    <tr class="form-field">
